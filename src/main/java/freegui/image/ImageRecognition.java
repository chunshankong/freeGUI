...
public class ImageRecognition {
    ...
    public void matchImage(Mat templateImage, Mat originalImage) {
        ...
        if (matchesPointCount >= 1) {
            ...
            Imgcodecs.imwrite(OpenCVTemplate.TEMP_PATH+"原图中的匹配图.jpg", subMat);
            ...
            Imgcodecs.imwrite(OpenCVTemplate.TEMP_PATH+"/特征点匹配过程.jpg", matchOutput);
            Imgcodecs.imwrite(OpenCVTemplate.TEMP_PATH+"/模板图在原图中的位置.jpg", originalImage);
        } else {
            System.out.println("模板图不在原图中！");
        }

        Imgcodecs.imwrite(OpenCVTemplate.TEMP_PATH+"/模板特征点.jpg", outputImage);
    }
    ...
    public static void main(String[] args) {
        ...
        Mat originalImage = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_COLOR);
